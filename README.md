# ML-and-DJANGO
#this is django project where we built full-stack application,which will classify radation with svm model and we can download the csv file(data used for prediction
